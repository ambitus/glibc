...
typedef void (*bpx4lcr_t) (int32_t *pathname_length,
			   const char *pathname,
...
int
__zos_lchattr (const char *pathname, struct zos_file_attrs *attrs,
	       unsigned long attrs_size)
{
  ...
  BPX_CALL (lchattr, bpx4lcr_t, &pathname_len, translated_path,
...
weak_alias (__zos_lchattr, zos_lchattr)
