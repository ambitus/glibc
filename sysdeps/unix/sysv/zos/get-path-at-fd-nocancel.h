...
#ifndef __GET_PATH_AT_FD_NOCANCEL_H
#define __GET_PATH_AT_FD_NOCANCEL_H
 ...
 */
static int
get_path_at_fd_nocancel (int fd, char *buffer, int buf_len)
{
  return GET_PATH_AT_FD_AS (, fd, buffer, buf_len);
}
