...
/* z/OS TODO: this is all z/Linux, port it to z/OS.  */
...
/* z/OS TODO: Use the sysconf syscall to give as much info as it can.  */
...
__sysconf (int name)
{
  ...
  switch (name)
    {
      struct rlimit rlimit __attribute__ ((unused));

      /* z/OS TODO: _SC_CPUTIME and _SC_THREAD_CPUTIME.  */
    case _SC_CPUTIME:
