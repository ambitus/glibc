...
#define __shim_enabled_creat(if_true, if_false) if_true
#define __shim_enabled_link(if_true, if_false) if_true
...
#define __shim_enabled_mknod(if_true, if_false) if_true
...
#define __shim_enabled_ptrace(if_true, if_false) if_true
#define __shim_enabled_alarm(if_true, if_false) if_true
#define __shim_enabled_pause(if_true, if_false) if_true
#define __shim_enabled_utime(if_true, if_false) if_true
...
#define __shim_enabled_rename(if_true, if_false) if_true
...
#define __shim_enabled_ioctl(if_true, if_false) if_true
#define __shim_enabled_fcntl(if_true, if_false) if_true
#define __shim_enabled_setpgid(if_true, if_false) if_true
...
#define __shim_enabled_setsid(if_true, if_false) if_true
...
#define __shim_enabled_wait4(if_true, if_false) if_true
...
#define __shim_enabled_fsync(if_true, if_false) if_true
...
#define __shim_enabled_poll(if_true, if_false) if_true
...
#define __shim_enabled_rt_sigprocmask(if_true, if_false) if_true
...
#define __shim_enabled_futex(if_true, if_false) if_true
...
#define __shim_enabled_fchmodat(if_true, if_false) if_true
...
#define __shim_enabled_set_robust_list(if_true, if_false) if_true
...
#define __shim_enabled_dup3(if_true, if_false) if_true
...
#define __shim_enabled_socket(if_true, if_false) if_true
#define __shim_enabled_socketpair(if_true, if_false) if_true
#define __shim_enabled_bind(if_true, if_false) if_true
...
#define __shim_enabled_getsockopt(if_true, if_false) if_true
#define __shim_enabled_setsockopt(if_true, if_false) if_true
#define __shim_enabled_getsockname(if_true, if_false) if_true
